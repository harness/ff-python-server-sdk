...
from featureflags.evaluation.feature import Distribution, Evaluation, FeatureConfig, Serve, WeightedVariation


def test_get_key_name():
    target = Target(identifier="john", attributes={
        'email': 'john@doe.com'
    })
...
def test_evaluate_basic():
    ...
    fc = FeatureConfig(feature='bool-flag',
